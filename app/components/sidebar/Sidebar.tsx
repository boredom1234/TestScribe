...
export function Sidebar({
  ...
  const panelOpenClass = isPinned ? 'translate-x-0' : '-translate-x-full peer-hover:translate-x-0 hover:translate-x-0';
  ...
  return (
    <div className="fixed left-0 top-0 h-full z-[90] hidden md:block pointer-events-none">
      ...
      <div className={`absolute left-0 top-0 h-full w-80 bg-[#fdf7fd] border-r border-[#ee81ca]/20 z-[91] flex flex-col transform ${panelOpenClass} transition-transform duration-200 ease-out shadow-lg pointer-events-auto`}>
      {/* Header */}
